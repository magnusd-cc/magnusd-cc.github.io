    ...
    _createClass(SlotMachine, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(PayTable, { payTable: newPayTable })
                ),
        ...
        value: function checkWin(reels) {
            ...
            for (var i = 0; i < payTable.length; i++) {
                winnings.push(payTable[i][occurrences[i]]);
            }
...
var payTable = [[0, 0, 0, 0], [0, 1, 2, 4], [0, 0, 0, 4], [0, 0, 0, 5], [0, 0, 0, 6], [0, 0, 0, 8]];

var newPayTable = [{ combination: ["bar", "bar", "bar"], pay: 8 }, { combination: ["banana", "banana", "banana"], pay: 6 }, { combination: ["lemon", "lemon", "lemon"], pay: 5 }, { combination: ["orange", "orange", "orange"], pay: 4 }, { combination: ["cherry", "cherry", "cherry"], pay: 4 }, { combination: ["cherry", "cherry"], pay: 2 }, { combination: ["cherry"], pay: 1 }];

...
var PayTable = function (_React$Component) {
    ...
    _createClass(PayTable, [{
        ...
        key: "renderTableContents",
        value: function renderTableContents() {
            var _this2 = this;

            var rows = newPayTable.map(function (tableRow) {
                return React.createElement(
                    "div",
                    null,
        ...
        value: function renderTableRow(symbols, pay) {
            ...
            var listItems = symbols.map(function (symbolName) {
                return React.createElement("img", { src: symbolName + ".png" });
            });
